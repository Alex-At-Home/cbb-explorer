...
export CONFS=${CONFS:="acc american atlanticten bigeast bigten bigtwelve pactwelve sec wcc mountainwest mvc conferenceusa mac socon sunbelt bigsky colonial summit women_acc women_american women_bigeast women_bigten women_bigtwelve women_pactwelve women_sec women_misc_conf"}
...
#export CONFS=${CONFS:="americaeast atlanticsun bigsouth horizon maac meac nec ovc patriot southland swac wac}
