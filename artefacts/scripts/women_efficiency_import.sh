...
TO_DOWNLOAD=$HOME/Downloads/2025_team_results.csv
rm -f $TO_DOWNLOAD
curl -o $TO_DOWNLOAD 'https://barttorvik.com/ncaaw/2025_team_results.csv'

TO_UPLOAD=$(ls -t $HOME/Downloads/ | grep -E "^2025_team_results[.]csv" | head -n 1)
if [[ "$TO_UPLOAD" != "" ]]; then
